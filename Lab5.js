...
const todos = [
  ...
  { id: 2, title: "Task 2", completed: true, description:"The seond task" },
...
const Lab5 = (app) => {
    app.get("/a5/module", (req, res) => {res.json(module)});
    app.get("/a5/module/name", (req, res) => {res.json(module.name)});
    ...
    app.get("/a5/todos/:id/completed/:newState", (req, res) => {
